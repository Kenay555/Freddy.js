      ...
      return {
        ...
        blocks: [
          ...
          },
          {
            ...
            text: "Let [NAM] be a fred with arq [ARQ], layers as [LYR], and L.R [LRT]",
            arguments: {
          ...
          },
          {
            opcode: "FreddyClear",
            blockType: Scratch.BlockType.COMMAND,
            text: "Delete ALL Freds",
          },
          {
            opcode: "FreddyExport",
            blockType: Scratch.BlockType.REPORTER,
            text: "export fred [NAM]",
            arguments: {
              NAM: { type: Scratch.ArgumentType.STRING, menu: "fredmenu" },
            },
          },
          ...
          {
            blockType: Scratch.BlockType.LABEL,
            text: 'Predictions and Revisions',
          },
          {
            opcode: "FreddyPredict",
            blockType: Scratch.BlockType.COMMAND,
            text: "Let [NAM] predict about [ARR]",
            arguments: {
              NAM: { type: Scratch.ArgumentType.STRING, menu: "fredmenu" },
          ...
          },
          {
            ...
            blockType: Scratch.BlockType.COMMAND,
            text: "Backpropagate [NAM] with [ARR]",
            arguments: {
              NAM: { type: Scratch.ArgumentType.STRING, menu: "fredmenu" },
              ARR: { type: Scratch.ArgumentType.STRING, defaultValue: '[2, 3, 1]' },
            },
          },
          {
            opcode: "FreddyTrain",
            blockType: Scratch.BlockType.COMMAND,
            text: "Train [NAM] with custom book [ARR], [EPCH] times",
            arguments: {
              NAM: { type: Scratch.ArgumentType.STRING, menu: "fredmenu" },
          ...
          },
          {
            opcode: "FreddyBook",
            blockType: Scratch.BlockType.COMMAND,
            text: "Train [NAM] with saved book [ARR], [EPCH] times",
            arguments: {
              NAM: { type: Scratch.ArgumentType.STRING, menu: "fredmenu" },
          ...
          },
          {
            opcode: "BookImport",
            blockType: Scratch.BlockType.COMMAND,
            text: "Let [NAM] be a book about [ARR]",
            arguments: {
              NAM: { type: Scratch.ArgumentType.STRING, defaultValue: 'new' },
              ARR: { type: Scratch.ArgumentType.STRING, defaultValue: '' },
            },
          ...
          },
          {
            opcode: "refillarray",
            blockType: Scratch.BlockType.REPORTER,
            text: "fill [ARRAY] to length [LNG] and filling [FILL]",
            arguments: {
